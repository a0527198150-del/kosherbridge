...
fun AdbChannelScreen(
  ...
  Column(
    ...
    SettingsCard("שלב 1 - הדלק ניפוי באגים אלחוטי") {
      ...
      Text(
        "תנאי מקדים שתופס רבים: באנדרואיד רגיל אי אפשר להדליק 'ניפוי באגים " +
          "אלחוטי' כשהנגן אינו מחובר לרשת Wi-Fi - המתג פשוט אפור. די בכל רשת, " +
          "כולל נקודה חמה מהטלפון, ואפשר לנתק אותה אחרי שהערוץ עובד. האפליקציה " +
          "עצמה לא פונה לשום רשת: הכתובת היחידה שהיא מחייגת היא 127.0.0.1, " +
          "כלומר הנגן עצמו.",
        style = MaterialTheme.typography.bodySmall,
      )
    ...
    SettingsCard("שלב 3 - התחבר") {
      Text(
        "אחרי התאמה מוצלחת, ההתחברות מתבצעת מעכשיו לבד: האפליקציה מתחברת שוב " +
          "בכל פעם שהיא צריכה את הערוץ, כולל אחרי כל הדלקה של הנגן. מספר " +
          "היציאה מוגרל מחדש בכל אתחול, ולכן הגילוי אוטומטי. הכפתור כאן הוא " +
          "לבדיקה ולמקרה שהגילוי נכשל - ואז הזן את היציאה שמוצגת במסך ניפוי " +
          "הבאגים האלחוטי (לא זו של ההתאמה).",
        style = MaterialTheme.typography.bodySmall,
      )
      Text(
        "חשוב: 'ניפוי באגים אלחוטי' חייב להישאר דלוק. הוא נכבה בחלק מהנגנים " +
          "בכיבוי מלא, ואז הערוץ לא יוכל להתחבר בעצמו.",
        style = MaterialTheme.typography.bodySmall,
      )
      OutlinedTextField(
        value = connectPort,
    ...
    SettingsCard("אחרי שזה עובד") {
      Text(
        "בחר הגדרות ← כל הגדרות החיבור ← 'ערוץ חיבור' ← 'דרך ADB מקומי'. " +
          "ההתאמה נשמרת בנגן לצמיתות, והחיבור מתחדש לבד.",
        style = MaterialTheme.typography.bodySmall,
      )
      Text(
        "ואם הדלקת כאן את פרופיל הדיבורית: המאפיין שמדליק אותו נמחק בכל אתחול " +
          "של הנגן. האפליקציה זוכרת איזה מאפיין עבד ומחזירה אותו לבד אחרי כל " +
          "הדלקה - אין צורך לחזור על ההדלקה ידנית.",
        style = MaterialTheme.typography.bodySmall,
      )
    }
  }
